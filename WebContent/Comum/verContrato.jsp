...
<body class="aw-layout-page">
	...
	<table class="table table-bordered table-striped">
		<tbody>
			<tr>
				<td rowspan="2" class="text-center col-md-1">N�mero: ${sessionScope.contratoVisualizar.numero}</td>
			...
			<tr>
				<td class="text-center col-md-1">Ass. ordem de servi�o: ${sessionScope.contratoVisualizar.dataOrdemServicoAsString}</td>
	...
	<table class="table table-bordered table-striped">
		<thead>
			<tr>
				...
				<th class="text-center col-md-1">Refer�ncia</th>
