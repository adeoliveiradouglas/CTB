	...
	<form action="sistema?logica=CadastrarProcesso" method="post">
		<div class="aw-simple-panel__box">	
			...
			<div class="form-group  has-feedback">
				<input type="text" class="form-control input-lg" placeholder="Número SEI" name="numero" required> 
				<span class="form-control-feedback"	aria-hidden="true"> </span>
			</div>
			
			<div class="form-group  has-feedback">
				<input type="text" class="form-control input-lg" placeholder="Nota fiscal" name="notaFiscal" required> 
				<span class="form-control-feedback"	aria-hidden="true"> </span>
			</div>
			...
			<div class="form-group  has-feedback">
				Data do processo:
				<input type="date" class="form-control input-lg" name="data" required> 
				<span class="form-control-feedback"	aria-hidden="true"> </span>
			</div>
			<div class="form-group  has-feedback" align="center">
				<input type="checkbox" name="aditivoChkBox" id="aditivoChkBox" value="Bike" onClick="aditivo()"> Houve aditivo?<br>
			</div>	
			<div class="form-group  has-feedback" id="valorAditivo" style="display:none">
				<input type="text" class="form-control input-lg" placeholder="Valor do aditivo" name="valorAditivo" maxlength="14" onkeyup="MascaraMoeda(this)"/>
				<span class="form-control-feedback"	aria-hidden="true"> </span>
			</div>	
			<div class="form-group  has-feedback" id="tipoAditivo" style="display:none" >
				<input type="text" class="form-control input-lg" placeholder="Tipo de aditivo" name="tipoAditivo"> 
				<span class="form-control-feedback"	aria-hidden="true"> </span>
			</div>	
