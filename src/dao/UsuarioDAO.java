/*
 * Classe respons�vel por acessar os dados de usuario no banco de dados
 */
 ...
 *		acessa tabela de novos usuários  importando qual o valor do parâmetro 
 */		
		super("usuariosnovos");
	}
...
//				Se o usuário só tiver 1 cargo, a posição do segundo fica somente com o id para nãp gerar erros mais tarde
				if(cargos.size() == 1){
...
//					busca setor de acordo com o resultado do usuario e salva somente sigla como na obs1 da classe Usuario
	...
	public List<Usuario> getAllGestor() {
		 ...
		 * 1�: busca na tabela cargo_has_usuario por todos os ids de usuarios que tem o idCargo = 3
		 * 2�: tranforma todos os ids em um objeto Usuario pelo método UsuarioDAO.getById
		 */
	...
	public List<Usuario> getAllByCargo(String cargo) {
		...
		/*
		 * Passo a passo desse método:
		 * 1�: busca na tabela cargo_has_usuario por todos os ids de usuarios que tem o idCargo = codCargo
		 * 2�: tranforma todos os ids em um objeto Usuario pelo método UsuarioDAO.getById
		 */
