/*Responsável por restringir o acesso às páginas de gestor*/
...
public class LoginGestor implements Filter{
 ...
 * */
		...
		try {
			if (cargosDoUsuario.get(0).getId() == 3 || cargosDoUsuario.get(1).getId() == 3)
