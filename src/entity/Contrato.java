 ...
 *
 *  Usando framework Lombok para gerar os getters e setters da classe atrav�s da anota��o "@Getter" e "@Setter"  
 ...
 *  obs5 - valor total � o valor de todos os aditivos de todos os dados mais o valor inicial do contrato
 *  	   Calcula somente quando � retorno de resultado do banco 	
 */
...
public class Contrato {
	...
	public String getNome() {
		//parametro para compara��o entre objetos
	...
	public BigDecimal getSaldo() {
		...
		switch(ultimo) {
			case -1:
//				caso o contrato n�o tenha dados atrelados a ele, o saldo � o valor inicial
...
//		Construtor usado para novos contratos pois n�o tem id do banco e nem entrada de dados
		this.numero = numero;
...
//		Soma o resultado do valor inicial com o valor dos aditivos e p�e em valorTotal
